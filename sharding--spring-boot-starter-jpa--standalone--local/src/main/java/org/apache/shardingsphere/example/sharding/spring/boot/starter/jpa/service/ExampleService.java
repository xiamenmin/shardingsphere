...
public final class ExampleService {
    ...
    private void processSuccess() throws SQLException {
        ...
        IntStream.range(1, 8)
                .parallel()
                .forEach(s -> {
                    final List<Order> orders = this.orderRepository.selectAll(orderIds);
                    LOGGER.info("Find data orders length:{}", orders.size());
                });
        LOGGER.info("cost:{}", System.currentTimeMillis() - t1);
    }
